...
### Important Notes :
Google Authentification requires a domain name to function, it cannot work with a public IP address.
For this reasion, currently, only the Facebook authentification is working.


## Step-by-step guide to setting up the server
...
```bash
ssh -p 2200 grader@52.26.199.55
```
...
#### The web application is now set up and running!
